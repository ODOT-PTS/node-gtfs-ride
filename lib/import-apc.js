...
import { formatRidecheckPlusLine } from './import-types/ridecheckplus.js';
...
const getAPCType = recordFieldNames => {
  ...
  const ridecheckPlusRequiredFieldNames = [
    'STOP_ID',
    'SIGNUP_NAME',
    'ROUTE_NUMBER',
    'TIME_ACTUAL_ARRIVE',
  ...
  if (ridecheckPlusRequiredFieldNames.every(fieldName => recordFieldNames.includes(fieldName))) {
    return 'ridecheckplus';
  }
